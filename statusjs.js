...
if("Free Shoutcast Hosting"!=n||"http://www.caster.fm/"!=a||"Radio Stream Hosting"!=r||"http://www.caster.fm/"!=d)alert("Please do not remove the Caster.fm link.\n  IT IS GOING TO BE HIDDEN ANYWAY.")
else{e.style.display="none",t.style.display="none"
var s="http://www.caster.fm/widgets/em_status.php?uid="+cstruid+"&dark="+cstrdark,i=document.createElement("iframe")
